...
TEAM_HIT = DarkRP.createJob("Hit", {
    ...
    description = [[Hit]],
    weapons = {"rw_sw_dc17m_sniper", "rw_sw_dc17m", "rw_sw_nade_thermal", "weapon_bactainjector", "tfa_defi_swrp", "salute_swep", "cross_arms_swep", "cross_arms_infront_swep", "re_hands", "weapon_cuff_elastic", "weapon_thehiddenblade", "rw_sw_nade_dioxis", "rw_sw_nade_smoke"},
    command = "hit",
    max = 0,
    salary = 5000,
    admin = 0,
